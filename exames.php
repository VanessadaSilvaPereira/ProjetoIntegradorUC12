...
<html>
    ...
    <body>
        ...
        <h3>Avaliação Extena:</h3>
        <div style="margin: 20px"> Esse exame é o primeiro contato do médico com o paciente.<br>
        ...
        <h3>Teste Ortóptico:</h3>
        <div style="margin: 20px"> Esse exame testa os músculos ligados à movimentação dos olhos e identifica alterações sensoriais, 
        ...
        <h3>Oftalmoscopia:</h3>
        <div style="margin: 20px">A oftalmoscopia — conhecida também como exame de fundo de olho — checa as condições do fundo do globo ocular.<br>
        ...
        <div style="margin: 20px">Por meio desse exame, é possível fazer o mapeamento topográfico do relevo da córnea e determinar a curvatura corneana.<br>
        ...
        <div style="margin: 20px"> Exame feito para verificar as condições da conjuntiva, pálpebras e parte anterior dos olhos. <br><br></div>
        
        <h3> Fundo de Olho:</h3> 
        <div style="margin: 20px"> Com o uso do oftalmoscópio o oftalmologista consegue ver e avaliar como está o nervo ótico, retina e os vasos da retina; <br><br></div>
        
        <h3>Teste do olhinho:</h3>
        <div style="margin: 20px"> Feito em bebês ainda nas primeiras semanas de vida é um exame que pode detectar doenças como catarata,
        ...
        <div style="margin: 20px">  Em consultas regulares são solicitados exames de rotina, como os apresentados.<br>
