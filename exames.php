...
<html>
    ...
    <body>
        ...
        <div id="div01">
            ...
            <h3 class="flip1">Exame de Retina<img src="imagens/setas.png" style="width:22px; margin-left:5px;"></h3>
            ...
            <h3 class="flip2">Exame de Refração<img src="imagens/setas.png" style="width:22px; margin-left:5px;"></h3>
            ...
            <h3 class="flip3">Avaliação Externa<img src="imagens/setas.png" style="width:22px; margin-left:5px;"></h3>
            ...
            <h3 class="flip4">Teste Ortóptico<img src="imagens/setas.png" style="width:22px; margin-left:5px;"></h3>
            ...
            <h3 class="flip5">Oftalmoscopia<img src="imagens/setas.png" style="width:22px; margin-left:5px;"></h3>
        ...
        <div id="div02">
            ...
            <h3 class="flip6">Topografia Corneana<img src="imagens/setas.png" style="width:22px; margin-left:5px;"></h3>
            ...
            <h3 class="flip7">Biomicroscopia<img src="imagens/setas.png" style="width:22px; margin-left:5px;"></h3>
            ...
            <h3 class="flip8"> Fundo de Olho<img src="imagens/setas.png" style="width:22px; margin-left:5px;"></h3> 
            ...
            <h3 class="flip9">Teste do olhinho<img src="imagens/setas.png" style="width:22px; margin-left:5px;"></h3>
            ...
            <h3 class="flip10">Exames Complementares<img src="imagens/setas.png" style="width:22px; margin-left:5px;"></h3>
