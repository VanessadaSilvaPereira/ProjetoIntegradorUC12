    ...
    <body>
        ...
        <div style="margin: 20px">   
            ...
            <div style="border: solid 2px black; text-align: center;font-size: 20px;background-color: yellow;"> Você já parou para pensar na quantidade de doenças dos olhos que existem? <br>
                ...
                costumamos tomar alguma ação quando ela já está prejudicada de certa forma.</div>
            ...
            <div style="width: 30%"><h3>  Ambliopia</h3>
                ...
                <p>Ela geralmente acontece em crianças e é caracterizada como uma doença que
                    prejudica a visão, mas que não pode ser corrigido somente com o uso de óculos.
                O tratamento é demorado, pois muitas vezes o problema não está restrito ao olho 
                    afetado, e sim à região cerebral responsável pela visão.</p>
                <p>Por afetar principalmente crianças, é comum que casos de ambliopia passem 
                    despercebidos pelos pais.
                Mas se não for tratado antes dos 7 ou 8 anos de idade, a doença
                    pode levar a um déficit de visão que durará pela vida toda.
                Por isso,acompanhamento oftalmológico é fundamental até mesmo nos primeiros anos de vida.</p>
            </div>

            <div style="width: 30%"><h3>  Astigmatismo</h3>
                ...
                associadoa algum trauma que a pessoa tenha sofrido no olho, como uma cicatrização, que altera a 
                refração da luz.</p>
                <p> Além do uso de óculos (recomendado para a maioria dos casos), é possível realizar um
                transplante de córnea para lidar com casos mais sérios.</p>


            </div>
            <div style="width: 30%"><h3>  Blefarite</h3>
                ...
                onde acabam sendo produzidas escamas muito semelhantes às caspas.
                Essa irritação e incômodo constantes podem afetar o resto do olho, portanto é fundamental
                tratá-la com limpezas recorrentes, compressas de água morna ou remédios receitados pelo médico.</p>
                <p> Eventualmente, xampus com pH neutro podem dar conta do recado também.
                Lentes de contato sujas também podem causar blefarite. Então, caso você use lentes, 
                mantenha-as sempre bem limpas.</p>

            </div>

            <div style="width: 30%"><h3>  Catarata</h3>
               ...
               <p> A catarata é uma doença bastante associada a idosos, pois a maioria das pessoas com mais
                ...
                <p>A catarata se caracteriza pela perda de transparência do cristalino, que é uma espécie de 
                    lente natural que temos dentro do olho. </p>
               <p> Isso ocorre lentamente e pode acontecer em somente um dos olhos
                primeiro, mas a tendência é que, sem tratamento, a catarata vá prejudicando a visão pouco a pouco,
                deixando a imagem mais embaçada assim, a cirurgia é o único tratamento eficaz contra a doença.</p>

            </div>

            <div style="width: 30%"><h3>  Ceratocone</h3>
               ...
               <p> A pessoa com ceratocone costuma ter sua visão debilitada de diversas formas: pode sofrer 
                perda do foco, diminuição da visão noturna, sentir alta sensibilidade à luz, entre outras situações. Ela 
                também pode ser caracterizada por um amento considerável de astigmatismo em um olho em comparação ao outro.</p>
               <p> Adolescentes e jovens têm mais chance de desenvolver a doença, de modo que ela raramente se 
                manifesta após os 30 anos de idade. Óculos e lentes de contato costumam resolver o problema, mas o 
                oftalmologista também pode ter de realizar algum procedimento cirúrgico, dependendo do caso.
                O acompanhamento médico também é fundamental, pois o ceratocone não controlado pode levar 
                eventualmente à perda de visão.</p>

            </div>
            <div style="width: 30%"><h3> Conjuntivite</h3>
               ...
               <p> Obviamente, o nível de irritação varia, assim como as causas: pode ser bacteriana, viral ou alérgica. 
                No caso da viral e bacteriana, ela é contagiosa, especialmente porque causa bastante lacrimação e a 
                pessoa geralmente limpa os olhos com as mãos.</p>
               <p> O tratamento da conjuntivite viral é apenas sintomático. O da bacteriana pode ser feito com o uso de 
                antibióticos receitados pelo médico.
                No caso da conjuntivite alérgica, ela não é contagiosa, mas incomoda pela coceira constante nos olhos.</p>

            </div>
            <div style="width: 30%"><h3>  Daltonismo</h3>
            ...
            <div style="width: 30%"><h3>  Descolamento de retina</h3>
               ...
               <p> A luz que entra em nosso olho é refratada de maneira a formar as imagens que enxergamos sobre a 
                ...
                para se manter funcionando. Quando ocorre o descolamento – por trauma, infecções, idade ou doenças – 
                a retina para 
                de receber estes nutrientes e começa a se debilitar.</p>
                <p>Se não for tratado com urgência, o descolamento de retina pode resultar em cegueira. Como esse
                descolamento não causa dor, a forma de percebê-lo é por meio da visão turva, pontos e manchas 
                escuras na visão (chamados de moscas volantes) ou fotopsias (flashes de luz repentinos).  O
                tratamento é, de forma geral, cirúrgico.</p>
            </div>

            <div style="width: 30%"><h3> Degeneração macular relacionada à idade (DMRI)</h3>
               ...
               <p> A degeneração macular relacionada à idade, também chamada de DMRI, acomete habitualmente pessoas  
                ...
                Ela se dá pela degeneração da área central da retina, causando problemas na visão central.</p>
                <p>É possível frear um pouco a evolução da doença por meio de acompanhamento nutricional e pela  
                utilização de óculos,  
                mas os danos já provocados por ela são geralmente irreversíveis. </p>

            </div>
            <div style="width: 30%"><h3> Estrabismo</h3>          
               ...
               <p> Popularmente chamadas de “vesgas”, as pessoas com estrabismo sofrem a falta de paralelismo dos olhos. 
                ...
                vertical entre eles. </p>
                <p>O estrabismo pode ser constante ou ocorrer intermitentemente. A pessoa estrábica comumente 
                sofre com dores de cabeça, torcicolos e eventualmente pode ter até perda parcial da visão. 
            ...
            <div style="width: 30%"><h3> Glaucoma</h3>            
                ...
                Essa hipertensão pode ter diversas causas, mas o importante é que, se não tratada, pode levar à cegueira.</p>
               <p> Ela costuma atingir pessoas de idade mais avançada, e o problema é que muitas vezes é assintomática.
                Por isso, é necessário realizar exames com regularidade no oftalmologista, especialmente após os 
                60 anos de idade.</p>
            </div>

            <div style="width: 30%"><h3>  Hipermetropia</h3>   
            ...
            <div style="width: 30%"><h3> Miopia</h3>   
                ...
                incidência é grande.
                Os olhos de pessoas com miopia possuem um formato mais alongado ou apresentam má formação das córneas ou 
                do cristalino, de maneira que a imagem da visão se forme antes da retina.</p>
                <p> Isso faz com que essas pessoas 
                tenham dificuldade para enxergar de longe, mas conseguirão ver normalmente de perto.
                Neste caso, ela não precisará de óculos para ler, por exemplo, mas talvez precise para enxergar a lousa 
                na escola ou ir a alguma peça de teatro.</p>
            ...
            <div style="width: 30%"><h3> Presbiopia ou vista cansada</h3>   
            ...
            <div style="width: 30%"><h3>  Pterígio </h3>   
            ...
            <div style="width: 30%"><h3>  Retinopatia</h3>   
            ...
            <div style="width: 30%"><h3>  Síndrome do olho seco</h3>   
                ...
                As pessoas que têm o chamado “olho seco”, assim, sentem uma pontada muito forte nos olhos, que passa 
                sozinho.</p>
                <p> No entanto, é preciso marcar uma consulta com um oftalmologista para que ele possa orientar
                    o tratamento mais adequado. Geralmente, ele é feito com o uso de colírios especiais.</p>
            </div>

            <div style="width: 30%"><h3>   Terçol</h3>   
            ...
            <div style="width: 30%"><h3>   Uveíte</h3>  
