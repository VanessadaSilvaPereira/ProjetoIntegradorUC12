...
<html>
    ...
    <div class="divespecialidades" > O oftalmologista é o médico 
    ...
    <div class="divespecialidades" >Dr. Adalberto: Especilista em cirurgia da catarata :</div>
    
    <div class="divespecialidades" > A Cirurgia de Catarata consiste na quebra
    ...
    (entre 2,4-2,8 mm) realizada na córnea. 
    . Atualmente existe um método mais moderno de cirurgia de catarata a laser,
    na qual utiliza-se um aparelho de laser de femtosegundo
    ...
    <div class="divespecialidades" >TRANSPLANTE DE CÉLULAS TRONCO (TRANSPLANTE DE LIMBO)</div>
     ...
     <div class="divespecialidades" >Neste procedimento levamos células tronco sadias do olho não afetado (doenças unilaterais),
    ...
    que é retirado do olho doador sadio não prejudica o doador pois a quantidade retirada é pequena.</div>

     <div class="divespecialidades" >Nos casos de doador cadáver é necessário utilizar medicamentos imunossupressores via oral para evitar
         a rejeição. Quando se consegue um bom pareamento HLA pode-se evitar a imunossupressão.</div>

     <div class="divespecialidades" >Trata-se de um procedimento ambulatorial realizado com anestesia local. Algumas vezes um futuro
         transplante de córnea é necessário para reabilitar a visão.</div>

    <div class="divespecialidades" > TRANSPLANTE DE MEMBRANA AMNIÓTICA</div>

    <div class="divespecialidades" > A membrana amniótica é previamente preparada a partir de uma placenta humana, e passa por um 
    ...
    córnea, ou nos casos de úlceras de córnea que não respondem ao tratamento convencional.</div>
    
     <div class="divespecialidades" >Também pode ser associada ao transplante de limbo, principalmente para refazer as áreas internas
         das pálpebras e melhorar as condições gerais do olho.</div>




    <div class="divespecialidades" > Dr. Vitor : Especilista em cirurgia de retina:</div>
